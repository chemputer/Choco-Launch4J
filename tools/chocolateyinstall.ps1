...
$url        = 'https://sourceforge.net/projects/launch4j/files/launch4j-3/3.14/launch4j-3.14-win32.exe/download' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'launch4j*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
